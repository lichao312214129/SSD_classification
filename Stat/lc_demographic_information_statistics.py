...
pearsonr(demographic_duration_dataset1['Duration'], demographic_duration_dataset1['Age'])
...
duration_age_dataset1 = demographic_duration_dataset1[['Duration','Age']].values
