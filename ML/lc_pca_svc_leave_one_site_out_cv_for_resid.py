...
class SVCRFECV():
    ...
    def __init__(
         ...
         resid_all=r'D:\WorkStation_2018\SZ_classification\Data\ML_data_npy\fc_excluded_greater_fd_and_regressed_out_site_age_sex_motion_all.mat',
...
if __name__ == '__main__':
    ...
    clf.save_fig(r'D:\WorkStation_2018\SZ_classification\Data\ML_data_npy\performances_fc_excluded_greater_fd_and_regressed_out_site_age_sex_motion_all.pdf')
    
    results = results.__dict__
    clf.save_results(results, r'D:\WorkStation_2018\SZ_classification\Data\ML_data_npy\results_fc_excluded_greater_fd_and_regressed_out_site_age_sex_motion_all.npy')
